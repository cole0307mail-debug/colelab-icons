    ...
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'React 文档', link: 'http://localhost:8000' },
        ],
        sidebar: {
          '/guide/': [
            {
        ...
        socialLinks: [{ icon: 'github', link: 'https://github.com/sensoro/sensoro-design-icons' }],
        outline: { level: [2, 3] },
      },
    },
    en: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'React Docs', link: 'http://localhost:8000' },
        ],
        sidebar: {
          '/en/guide/': [
            {
